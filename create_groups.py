...
from app.database.models import Lesson, Group, Faculty, Speciality, Schedule
...
async def create_groups_from_lessons():
    ...
    async for session in get_session():
        ...
        for lesson in lessons:
            ...
            print(f"Создана группа: {study_group} (курс {course}, {faculty.name}, {speciality.name})")
