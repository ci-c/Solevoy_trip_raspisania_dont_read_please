...
- Вычисление номера текущей учебной недели
- Определение учебного года в формате "2024/2025"
- Генерация приоритетных фильтров для поиска актуальных расписаний
- Обработка переходных периодов между семестрами
...
class SemesterDetector:
    ...
    def get_priority_filters(self) -> dict:
        ...
        return {"semester": info.name, "academicYear": info.year}
