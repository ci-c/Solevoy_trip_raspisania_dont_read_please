...
from app.models.education import Speciality, StudyGroup, Teacher, Room
        ...
        async for conn in self.db.get_connection():
            ...
            if existing:
                ...
                """,
                    (
                        speciality.name,
                        speciality.full_name,
                        speciality.faculty,
                        speciality.degree_type.value,
                        speciality.study_years,
                        speciality.code,
                    ),
                )
