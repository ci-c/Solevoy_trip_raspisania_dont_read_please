...
class InvitationService:
    ...
    async def use_invitation(self, code: str, user_id: int) -> tuple[bool, str, Optional[AccessLevel]]:
        """Использовать инвайт.
    ...
    async def deactivate_invitation(self, code: str, user_id: Optional[int] = None) -> bool:
