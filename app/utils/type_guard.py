...
def safe_type_convert(value: Any, target_type: Type[T], default: T | None = None) -> T | None:
...
def validate_dict_structure(data: dict[str, Any], expected_structure: dict[str, Type]) -> bool:
