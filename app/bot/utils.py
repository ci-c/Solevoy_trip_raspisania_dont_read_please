...
async def show_loading_spinner(message: Message, text_prefix: str = "⏳ Загрузка", duration: int = 10):
...
def truncate_text(text: str, max_length: int = 4000, suffix: str = "... (сокращено)") -> str:
...
def create_progress_text(current: int, total: int, item_name: str = "элемент") -> str:
    ...
    return f"📊 Обработка: {current}/{total} {item_name}\n[{progress_bar}] {percentage}%"