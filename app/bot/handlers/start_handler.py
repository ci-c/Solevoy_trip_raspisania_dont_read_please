...
async def cmd_start(message: types.Message, state: FSMContext) -> None:
    ...
    try:
        ...
        if user_profile:
            ...
            # Новый пользователь
            await message.answer(
                f"👋 Добро пожаловать в СЗГМУ Schedule Bot!\n\n"
                f"🤖 Я помогу вам с расписанием занятий, оценками и документами.\n\n"
                f"Для начала настройте свой профиль или воспользуйтесь поиском:",
        ...
        await message.answer(
            f"❌ Произошла ошибка при запуске бота.\n\n"
