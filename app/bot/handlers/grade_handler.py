...
from app.bot.keyboards import get_main_menu_keyboard, get_grades_keyboard, get_subject_grades_keyboard
...
async def handle_add_grade(
    ...
    try:
        ...
        keyboard = types.InlineKeyboardMarkup(inline_keyboard=[
            [
                types.InlineKeyboardButton(text="📝 Контрольная", callback_data=GradeCallback(action="grade_type", subject=subject, data="контрольная").pack()),
                types.InlineKeyboardButton(text="🧪 Лабораторная", callback_data=GradeCallback(action="grade_type", subject=subject, data="лабораторная").pack()),
            ],
            [
                types.InlineKeyboardButton(text="📖 Устный ответ", callback_data=GradeCallback(action="grade_type", subject=subject, data="устный").pack()),
                types.InlineKeyboardButton(text="📄 Реферат", callback_data=GradeCallback(action="grade_type", subject=subject, data="реферат").pack()),
            ],
            [
                types.InlineKeyboardButton(text="📊 Зачет", callback_data=GradeCallback(action="grade_type", subject=subject, data="зачет").pack()),
                types.InlineKeyboardButton(text="✍️ Свой вариант", callback_data=GradeCallback(action="grade_type", subject=subject, data="другое").pack()),
            ],
            [
                types.InlineKeyboardButton(text="⬅️ Назад", callback_data=GradeCallback(action="view_subject", subject=subject).pack()),
            ]
        ])
...
async def handle_grade_type_selection(
    ...
    try:
        ...
        keyboard = types.InlineKeyboardMarkup(inline_keyboard=[
            [
                types.InlineKeyboardButton(text="5️⃣", callback_data=GradeCallback(action="grade_value", subject=subject, data="5").pack()),
                types.InlineKeyboardButton(text="4️⃣", callback_data=GradeCallback(action="grade_value", subject=subject, data="4").pack()),
            ],
            [
                types.InlineKeyboardButton(text="3️⃣", callback_data=GradeCallback(action="grade_value", subject=subject, data="3").pack()),
                types.InlineKeyboardButton(text="2️⃣", callback_data=GradeCallback(action="grade_value", subject=subject, data="2").pack()),
            ],
            [
                types.InlineKeyboardButton(text="⬅️ Назад", callback_data=GradeCallback(action="add_grade", subject=subject).pack()),
            ]
        ])
        ...
        if success:
            await callback.message.edit_text(
                ...
                reply_markup=types.InlineKeyboardMarkup(inline_keyboard=[
                    [
                        types.InlineKeyboardButton(text="📚 К предмету", callback_data=GradeCallback(action="view_subject", subject=subject).pack()),
                        types.InlineKeyboardButton(text="🏠 В меню", callback_data=MenuCallback(action="grades").pack()),
                    ]
                ])
            )
        else:
...
async def handle_add_attendance(
    ...
    try:
        ...
        keyboard = types.InlineKeyboardMarkup(inline_keyboard=[
            [
                types.InlineKeyboardButton(text="📚 Лекция", callback_data=GradeCallback(action="attendance_type", subject=subject, data="лекция").pack()),
                types.InlineKeyboardButton(text="🧪 Семинар", callback_data=GradeCallback(action="attendance_type", subject=subject, data="семинар").pack()),
            ],
            [
                types.InlineKeyboardButton(text="⬅️ Назад", callback_data=GradeCallback(action="view_subject", subject=subject).pack()),
            ]
...
async def handle_attendance_type_selection(
    ...
    try:
        ...
        keyboard = types.InlineKeyboardMarkup(inline_keyboard=[
            [
                types.InlineKeyboardButton(text="✅ Присутствовал", callback_data=GradeCallback(action="attendance_status", subject=subject, data="present").pack()),
                types.InlineKeyboardButton(text="❌ Отсутствовал", callback_data=GradeCallback(action="attendance_status", subject=subject, data="absent").pack()),
            ],
            [
                types.InlineKeyboardButton(text="🏥 По уважительной причине", callback_data=GradeCallback(action="attendance_status", subject=subject, data="excused").pack()),
            ],
            [
                types.InlineKeyboardButton(text="⬅️ Назад", callback_data=GradeCallback(action="add_attendance", subject=subject).pack()),
            ]
        ])
...
async def register_grade_handlers(dp: Dispatcher) -> None:
    ...
    dp.callback_query.register(handle_attendance_status_selection, GradeCallback.filter())
