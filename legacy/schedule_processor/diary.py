        ...
        try:
            ...
            self.homeworks = [
                Homework(
                    ...
                    completed_date=datetime.fromisoformat(hw["completed_date"]).date()
                    if hw.get("completed_date")
                    else None,
                    notes=hw.get("notes"),
                )
            ...
            self.absences = [
                Absence(
                    ...
                    makeup_date=datetime.fromisoformat(a["makeup_date"]).date()
                    if a.get("makeup_date")
                    else None,
                ...
                "homeworks": [
                    {
                        ...
                        "completed_date": hw.completed_date.isoformat()
                ...
                "absences": [
                    {
                        ...
                        "excused": a.excused,
                        "made_up": a.made_up,
                        "makeup_date": a.makeup_date.isoformat()
                        if a.makeup_date
                        else None,
