...
class TestUserService:
    ...
    async def test_create_user_success(
        self, test_user_service: UserService, sample_user_data
    ):
    ...
    async def test_get_user_by_telegram_id_not_existing(
        self, test_user_service: UserService
    ):
    ...
    async def test_update_user_activity(self, test_user_service: UserService):
        ...
        user = await test_user_service.create_user(
            telegram_id=123456789, telegram_username="test_user", full_name="Test User"
        )
    ...
    async def test_update_user_access_level(self, test_user_service: UserService):
        ...
        result = await test_user_service.update_user_access_level(
            user.id, AccessLevel.ADMIN
        )
